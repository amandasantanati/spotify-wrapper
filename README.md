...
// using  method
spotify.search.artists('The Cranberries');
```
...
This is a project built during [Willian Justen's JS with TDD course at Udemy](https://www.udemy.com/course/js-com-tdd-na-pratica).
